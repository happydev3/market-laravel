...
@section('page_content')
    ...
    <div class="dashboard-content">
        ...
        <div class="headline statement primary">
            <h4>@lang('store_panel.cash_invoices_panel_title') ({{$totalInvoices}})</h4>
        </div>
        <!-- /HEADLINE -->
            ...
            @foreach($invoices as $invoice)
                <div class="transaction-list-item">
                    <div class="transaction-list-item-date">
                        <p>CASH-{{$invoice->invoice_number}}-{{$invoice->created_at->format('y')}}</p>
                    </div>
                    ...
                    <div class="transaction-list-item-cut">
                        <p><span class="light"><a href="{{route('store.cash_invoice.download',['invoice_id' => $invoice->id ])}}" class="primary">@lang('store_panel.invoice_download_button')</a></span></p>
                    </div>
                </div>
        @endforeach
