...
@section('page_content')
    ...
    <div class="dashboard-content">
        ...
        <div class="headline simple primary">
            ...
            <a href="mailto:?subject=@lang('user_panel.invite_mail_subject')&body=@lang('user_panel.invite_mail_content') {{Auth::guard('store')->user()->business_name}},

@lang('user_panel.invite_mail_content2') {{Auth::guard('store')->user()->own_referral_code}}" class="button mid-short primary">@lang('user_panel.invite_friend_btn')</a>
        </div>
        <!-- /HEADLINE -->
        ...
        <div class="form-box-items wrap-3-1 left">
            ...
            <div class="form-box-item full not-padded not-spaced">
                <h4>@lang('store_panel.invited_users')({{$totalUsers}})</h4>
            ...
            <div class="form-box-item full">
                ...
                <div class="colors-pie-chart-wrap">
                    ...
                    <div class="chart-description">
                        <p class="text-header">{{number_format($earnings,2)}}€</p>
