...
@section('page_title') @lang('page_titles.edit_branch') @endsection
...
@section('page_content')
    ...
    <div class="dashboard-content">
        ...
        <div class="headline simple primary">
            <h4>@lang('store_panel.update_branch_panel_title')</h4>
        </div>
        <!-- /HEADLINE -->

        <!-- FORM BOX ITEMS -->
        <div class="form-box-items wrap-3-1 left">
            <form action="{{route('store.branch.update')}}" method="POST" id="address-form">
                ...
                <div class="form-box-item full">
                    ...
                    <button class="button big dark" id="update_address_btn">@lang('store_panel.update_branch_button')</button>
                </div>
            </form>
        </div>
        <!-- /FORM BOX ITEMS -->
...
@section('custom_js')
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBFVt2WccdiOFmDTQhNaahcgp_v5yUhMRA&lang=it&libraries=places"></script>
    ...
    <script>
        ...
        $('#address').geocomplete({
            ...
            country: "IT",
            map: "#address_map",
            location: "{{$branch->street_address}}",
            markerOptions: {
