                            ...
                            <div class="card-body">
                                <div class="p-15">
                                    <div class="m-b-30">
                                        ...
                                        <h2 class="inline-block pull-right m-v-0 p-t-15">@lang('pages_text.store_area')</h2>
                                    </div>
                                    ...
                                    <form  action="{{ route('store.login.submit') }}" method="post">
                                        ...
                                        <div class="pull-right">
                                            <a href="{{route('store.password.request')}}">@lang('auth.forgot_password')</a>
                                        </div>
                                        <div class="m-t-20 text-right">
                                            <button type="submit" class="btn btn-gradient-danger">@lang('auth.login_button')</button>
                                        </div>
                                    </form>
                                    <p align="center">@lang('auth.login_register') <a href="{{ route('store.register') }}">@lang('auth.login_register_invite')</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
