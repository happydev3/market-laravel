...
<div style="clear:both; position:relative;">
    ...
    <div style="margin-left:300pt;">
        ...
        <b>Fattura CASH_{{$invoice->invoice_number}}-{{$invoice->created_at->format('y')}}</b>
        <br />
    </div>
</div>
<br />
<h2>Fattura : CASH_{{$invoice->invoice_number}}-{{$invoice->created_at->format('y')}}</h2>
<div style="clear:both; position:relative;">
    <div style="position:absolute; left:0pt; width:250pt;">
        <h4>Emessa Da:</h4>
    ...
    <div style="margin-left: 300pt;">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                {{$invoice->store->street_address}} <br/>
...
<div style="clear:both; position:relative;">
    ...
    <div style="position:absolute; left:0pt; width:250pt;">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                Il pagamento dovrà essere eseguito entro 14 giorni dalla data della presente fattura.
            </div>
        </div>
    </div>
