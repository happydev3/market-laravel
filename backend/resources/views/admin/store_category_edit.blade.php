            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                    ...
                    <div class="page-title">
                        <h5>@lang('admin.edit_store_category_heading')</h5>
                    </div>
                </div>
        ...
        <div class="row gutters">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.store_category_edit.submit') }}" method="POST">
                            {{ csrf_field() }}
                            <input type="hidden" name="storeCategoryId" value="{{$storeCategory->id}}">
                            <div class="form-group">
                                <label for="catName">@lang('admin.category_name_label')</label>
                                <input class="form-control" id="catName" placeholder="@lang('admin.category_name_placeholder')" type="text" name="categoryName" value="{{ $storeCategory->name }}">
                            </div>
                            <div class="form-group">
