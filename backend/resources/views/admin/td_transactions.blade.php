...
@section('page_title') @lang('admin.td_transactions') @endsection
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                    ...
                    <div class="page-title">
                        <h5>@lang('admin.td_transactions_header')</h5>
                        <h6 class="sub-heading">@lang('admin.td_transactions_subheader')</h6>
                    </div>
                </div>
...
@section('custom_js')
    ...
    <script>
        var transactionTable = $('#transactionsTable').DataTable({
            "ajax" : {"url" : " {{route('admin.ajax_td_transactions')}}","dataSrc":""},
            "columns" : [
                {"data" : "created_at"},
                {"data" : "user.name"},
                {"data" : "store.name"},
