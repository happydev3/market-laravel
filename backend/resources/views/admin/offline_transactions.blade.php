...
@section('page_title') @lang('admin.admin_offline_transactions') @endsection
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                    ...
                    <div class="page-title">
                        <h5>@lang('admin.offline_transactions_heading')</h5>
                        <h6 class="sub-heading">@lang('admin.online_transactions_subheading') {{ $offlineTransactionsCount }}</h6>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <table id="transactionsTable" class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <th>@lang('admin.transaction_dp_id')</th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
@section('custom_js')
    ...
    <script>
        var transactionTable = $('#transactionsTable').DataTable({
            "ajax" : {"url" : " {{route('admin.ajax_all_offline_tr')}}","dataSrc":""},
            "aaSorting": [[0,'desc']],
            "columns" : [
                {"data" : "created_at"},
                {"data" : "user.name"},
