...
@section('page_title') @lang('admin.admin_online_transactions') @endsection
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                    ...
                    <div class="page-title">
                        <h5>@lang('admin.online_transactions_heading')</h5>
                        <h6 class="sub-heading">@lang('admin.online_transactions_subheading') {{ $onlineTransactionsCount }}</h6>
                    </div>
                </div>
...
@section('custom_js')
    ...
    <script>
        var transactionTable = $('#transactionsTable').DataTable({
            "ajax" : {"url" : " {{route('admin.ajax_all_online_tr')}}","dataSrc":""},
            "aaSorting": [[0,'desc']],
            "columns" : [
                {"data" : "created_at"},
                {"data" : "user.name"},
