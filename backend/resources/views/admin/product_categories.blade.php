...
@section('page_title') @lang('admin.admin_product_categories') @endsection
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                    ...
                    <div class="page-title">
                        <h5>@lang('admin.product_categories_heading')</h5>
                        <h6 class="sub-heading">@lang('admin.product_categories_subheading') {{ $productCategoriesCount }}</h6>
                    </div>
                </div>
    ...
    <div class="main-content">
        ...
        <div class="row gutters">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">@lang('admin.add_new_category_panel')</div>
                    <div class="card-body">
                        <form action="{{ route('admin.new_product_category.submit') }}" method="POST">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label for="catName">@lang('admin.category_name_label')</label>
                                <input class="form-control" id="catName" placeholder="@lang('admin.category_name_placeholder')" type="text" name="categoryName">
                            </div>
                            <div class="form-group">
                                <label for="langSelect">@lang('admin.language_label')</label>
                                <select class="form-control" id="langSelect" name="categoryLang">
...
@section('custom_js')
    ...
    <script>
        $('#categoriesTable').DataTable({
            "ajax" : {"url" : " {{route('admin.ajax_product_categories')}}","dataSrc":""},
            "columns" : [
                {"data" : "id"},
                {"data" : "name"},
                {"data" : "lang"},
                ...
                },
                {
                    ...
                    "render" : function (data,type,row) {
                        var btn = '<a href="product_category/switch/' + data + '\" class="btn btn-warning"> @lang('admin.enable_disable') </a>';
                        var btn2 = '  <a href="product_category/edit/' + data + '\" class="btn btn-success"> @lang('admin.edit_category')  </a>';
                        return btn + btn2;
                    }
                }
            ]
