...
@section('page_title') @lang('admin.admin_users_page') @endsection
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                    ...
                    <div class="page-title">
                        <h5>@lang('admin.users_heading')</h5>
                        <h6 class="sub-heading">@lang('admin.users_subheading')</h6>
                    </div>
                </div>
    ...
    <div class="main-content">
        <div class="row gutters">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">@lang('admin.users_table_title')</div>
                    <div class="card-body">
...
@section('custom_js')
    ...
    <script>
        $('#usersTable').DataTable({
            "ajax" : {"url" : " {{route('admin.ajax_users')}}","dataSrc":""},
            dom: 'Bfrtip',
            buttons: [
                'excelHtml5',
                'csvHtml5',
            ...
            "columns" : [
                ...
                {"data" : "invited_by"},
                {
                    ...
                    "render" : function (data,type,row) {
                        var btn = '<a href="user/details/' + data + '\" class="btn btn-success"> @lang('admin.table_details') </a>';
                        return btn;
                    }
                }
            ]
