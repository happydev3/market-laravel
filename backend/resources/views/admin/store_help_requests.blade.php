...
@section('page_title') @lang('admin.admin_store_help_request') @endsection
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                    ...
                    <div class="page-title">
                        <h5>@lang('admin.store_request_title')</h5>
                        <h6 class="sub-heading">@lang('admin.store_request_subtitle')</h6>
                    </div>
                </div>
    ...
    <div class="main-content">
        <div class="row gutters">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">@lang('admin.store_request_title')</div>
                    <div class="card-body">
                        <table class="table table-bordered table-responsive">
                            <thead>
                            <tr>
                                <th>#</th>
                                <th>@lang('admin.request_table_store')</th>
                            ...
                            <tbody>
                                @foreach($requests as $r)
                                    <tr>
                                        ...
                                        <td>
                                            @if($r->answered)
                                               <a href="{{route('admin.store_help_single_show',['id' => $r->id])}}" class="btn btn-secondary">@lang('admin.open_request')</a>
                                            @else
                                               <a href="{{route('admin.store_help_single',['id'=>$r->id])}}" class="btn btn-success">@lang('admin.answer_btn')</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
